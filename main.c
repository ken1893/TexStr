...
extern  void  App_COLLECTTaskCreate (void);
extern  void  App_CYCSENDTaskCreate (void);
/*
*********************************************************************************************************
*                                                main()
*
...
{   
	...
	for(;;)
   	{
      	OSTimeDlyHMSM(1, 0, 0, 0);							 /* Delay One minute */
    }	
}
/*
*********************************************************************************************************
...
static  void  App_TaskCreate (void)
{
	...
	App_BlinkTaskCreate();	     // GPIO TASK LIKE PWM\INPUT\OUTPUT
	App_CYCSENDTaskCreate();     // SERIAL COM
	App_COLLECTTaskCreate();     // ADS1115
}
