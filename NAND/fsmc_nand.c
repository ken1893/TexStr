...
/* Private define ------------------------------------------------------------*/
#define NAND_FLASH_START_ADDR     ((uint32_t)0x70080000) 
...
/* A18 74lvc139 NAND pin configuration */ 
  ...
  FSMC_NANDInitStructure.FSMC_Bank = FSMC_Bank2_NAND;	   // Bank2 NAMD
  FSMC_NANDInitStructure.FSMC_Waitfeature = FSMC_Waitfeature_Enable;
  FSMC_NANDInitStructure.FSMC_MemoryDataWidth = FSMC_MemoryDataWidth_8b;    // NAND 8Î»
